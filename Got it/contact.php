...
$EmailTo = "alcorta.bruno@gmail.com"; // Your email address here
	...
	<div class="contact-page main grid-wrap">
		...
		<aside class="grid col-one-quarter mq2-col-one-third mq3-col-full">
			...
			<address class="mbottom">
				...
				Level 4, Door 01 <br >
				11200 MONTEVIDEO<br >
				<a href="http://goo.gl/maps/JnTXS">Get directions</a>
			</address>
			...
			<p class="mbottom">
				...
				<a href="https://www.facebook.com/gotasoft">GOTASOFT on Facebook</a><br >
				<a href="https://twitter.com/gotasoft">@gotasoft on Twitter</a><br >				
			</p>
			<p>
		...
		<section class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
			...
			if ($success){		
			?>
			<h2>TANKS! We will contacnt you back soon</h2>
			<?
			}
			else{
			?>			
			...
			<form id="contact_form" class="contact_form" action="contact.php" method="post" name="contact_form">	
				<ul>
					...
					<li>
						...
						<input type="email" name="email" id="email" required placeholder="example@example.com" class="required email">
					</li>	
					<li>
...
<footer class="grid-wrap">
	<ul class="grid col-one-third social">
		<li><a href="https://www.facebook.com/gotasoft">Facebook</a></li>
			<li><a href="https://twitter.com/gotasoft">Twitter</a></li>
	</ul>
